 ...
 * [hancestro.yml](hancestro.yml)
     * Determines how your purl.obolibrary.org/obo/hancestro/ redirects will be handled
     ...
     * Paste in the contents of [hancestro.yml](hancestro.yml)
 ...
 * [hancestro.md](hancestro.md)
     ...
     * Paste in the contents of [hancestro.md](hancestro.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
